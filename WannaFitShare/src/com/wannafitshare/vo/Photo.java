...
public class Photo {
	...
	public String toString() {
		return "Photo [photoId=" + photoId + ", photoName=" + photoName + ", photoPath=" + photoPath + ", photoTime="
				+ photoTime + ", comment=" + comment + "]";
	}
	public Photo(String photoName, String photoPath, Date photoTime, String comment) {
		super();
		this.photoName = photoName;
		this.photoPath = photoPath;
		this.photoTime = photoTime;
	...
	public Photo(int photoId, String photoName, String photoPath, Date photoTime, String comment) {
		super();
		this.photoId = photoId;
		this.photoName = photoName;
		this.photoPath = photoPath;
