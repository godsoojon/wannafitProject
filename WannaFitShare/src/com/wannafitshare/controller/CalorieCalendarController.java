...
public class CalorieCalendarController {
	...
	public String saveCalorieCalendar(@RequestParam String csId,
			...
			@RequestParam String day, @RequestParam int totalCalorie,
			HttpSession session) {
		CalorieCalendar temp = new CalorieCalendar(csId,
				new Date(Integer.parseInt(year) - 1900,
	...
	public String printTotalCalorie(@RequestParam String csId,
		...
		return "/calendarPop.jsp?year=" + year + "&month=" + month + "&day="
				+ day + "&csId=" + csId + "&printcal="
				+ result.getTotalCalorie();
	}
}
