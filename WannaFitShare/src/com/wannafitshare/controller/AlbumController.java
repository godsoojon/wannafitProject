...
public class AlbumController {
	...
	public String see(HttpSession session, ModelMap model) {
		...
		List<PhotoUpload> list = service.listPhotoUpload(partyName);

		

		/*System.out.println(partyName + "---파티 이름");
		...
		while (itr.hasNext()) {
			...
			if (o.getPartyName().equals(partyName)) {
				System.out.println(o.getPartyName() + "--------" + partyName);
				listBypartyName.add(o);
			}
		}*/
		//session.setAttribute("party", partyName);
		model.addAttribute("listPhotoUpload", list);
