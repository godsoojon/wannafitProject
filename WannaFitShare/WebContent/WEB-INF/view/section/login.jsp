	...
	<div class="container">
		...
		<form class="form-login"
			...
			<div class="login-wrap">
				<input id="csId" name="csId" type="text" class="form-control"
					...
					id="csPassword" name="csPassword" class="form-control"
					placeholder="Password"> <br>
				<form:errors path="customer.csPassword" delimiter=" | " />
				</span><br> <label class="checkbox"> <span class="pull-right">
						<a data-toggle="modal" href="login.html#myModal"> Forgot
							Password?</a>
