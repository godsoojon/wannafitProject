...
<form action="${initParam.rootPath}/health/addHealth.do" method="post"
	...
	<table border="1" style="width: 500px">
		...
		<tr>
			<th>혈압</th>
			<td><input type="number" id="hBloodPressure"
				name="hBloodPressure" size="25"> <span class="errorMessage"
				id="idErrorMessage"></span></span></td>
		</tr>
		<tr>
			<th>bmi</th>
			<td>키와 몸무게 입력하면 자동 입력됩니다. <input type="hidden" name="bmi"
				id="bmi" value="0"> <span class="errorMessage"
				id="idErrorMessage"></span></td>
		</tr>
		<tr>
			<th>혈당</th>
			<td><input type="number" id="hBloodSugar" name="hBloodSugar"
				size="25"> <span class="errorMessage" id="idErrorMessage"></span></span></td>
		</tr>
		<tr>
			<th>LDL</th>
