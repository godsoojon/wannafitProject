		...
		<div class="row mt">
			<div class="col-lg-12">
				<div class="form-panel">
					<h4 class="mb">
						<i class="fa fa-angle-right"></i> 건강정보 등록
					</h4>
					<form class="form-horizontal style-form"
						action="${initParam.rootPath}/health/addHealth.do" method="post"
						id="regForm">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" class="form-control round-form"
									id="hWeight" name="hWeight"> <span class="help-block">몸무게를
									입력해 주세요</span><br> <span class="errorMessage" id="idErrorMessage"></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" class="form-control round-form" id="hTall"
									name="hTall"> <span class="help-block">키를 입력해
									주세요.</span><br> <span class="errorMessage" id="idErrorMessage"></span>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" class="form-control round-form"
									...
									class="help-block">혈압~~~~</span><br> <span
									class="errorMessage" id="idErrorMessage"></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="hidden" class="form-control round-form" name="bmi"
									id="bmi" value="0"> <span class="help-block">키와
									몸무게 입력하면 자동 입력됩니다.</span><br> <span class="errorMessage"
									id="idErrorMessage"></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" class="form-control round-form"
									id="hBloodSugar" name="hBloodSugar"> <span
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" class="form-control round-form" id="hLdl"
									name="hLdl"> <span class="help-block">low
									density lipoprotein의 약칭이며 비중 1,019~1,063 사이의 분리되는 혈장지질단백질로,
									콜레스테롤을 말초로 보내는 기능을 한다. LDL 농도가 높으면 죽상동맥경화가 되기 쉽다. 간에서 합성된
									콜레스테롤을 체조직으로 운반하는 역할을 한다.</span><br> <span class="errorMessage"
									id="idErrorMessage"></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" class="form-control round-form" id="hHdh"
									name="hHdh"> <span class="help-block">HDH</span><br>
								<span class="errorMessage" id="idErrorMessage"></span>
							</div>
						</div>
						<input type="submit" value="건강정보 등록"
