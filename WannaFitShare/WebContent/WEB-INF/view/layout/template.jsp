...
<link rel="stylesheet" type="text/css"
	href="${initParam.rootPath}/assets/css/zabuto_calendar.css">
<link rel="stylesheet" type="text/css"
	href="${initParam.rootPath}/assets/js/gritter/css/jquery.gritter.css" />
<link rel="stylesheet" type="text/css"
	href="${initParam.rootPath}/assets/lineicons/style.css">
