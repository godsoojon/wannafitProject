    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/WannaFitShare/album/multiplePhotoUpload.do'
    	//파일을 하나씩 보내고, 결과를 받음.
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 	    	...
 	    	sUrl : '/WannaFitShare/album/photoUpload.do',
 	    	sCallback : '/WannaFitShare/board/photo_uploader/popup/callback.html',
